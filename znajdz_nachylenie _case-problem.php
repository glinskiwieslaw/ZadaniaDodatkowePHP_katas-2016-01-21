<?php
/*
 * Napisz funkcję która wyznaczy pochylenie prostej opisanej przez dwa punkty. Funkcja ta ma przyjmować cztery zmienne liczbowe (zarówno liczby zmiennoprzecinkowe jak i liczby całkowite): a, b, c, d gdzie:
